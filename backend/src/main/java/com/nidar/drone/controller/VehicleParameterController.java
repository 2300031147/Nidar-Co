...
import com.nidar.drone.repository.VehicleParameterRepository;
import com.nidar.drone.service.MAVProxyService;
...
public class VehicleParameterController {
    ...
    @PostMapping
    public ResponseEntity<VehicleParameter> createParameter(@RequestBody VehicleParameter parameter) {
